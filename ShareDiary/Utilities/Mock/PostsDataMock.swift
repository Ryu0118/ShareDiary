    ...
    static func createMock() -> [PostsData] {
        [
            PostsData(year: 2022, data: [7, 2, 0, 13, 22, 9, 6, 8, 5, 4, 6, 12], impressionLevels: [
                ...
                ImpressionLevel(level: 2, postsCount: 10),
                ImpressionLevel(level: 3, postsCount: 10),
                ImpressionLevel(level: 4, postsCount: 10),
                ImpressionLevel(level: 5, postsCount: 10),
                ImpressionLevel(level: 6, postsCount: 10),
